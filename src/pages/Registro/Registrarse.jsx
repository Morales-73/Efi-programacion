...
function Registrarse(){
    ...
    const {paginas, registrate} = idioma

    return(<>
            <div className="container">
                <div className="row d-flex justify-content-center align-items-center">
                    <div className="col-lg-12 col-xl-11 mb-5 mt-5">
                        <div className="row justify-content-center border bg-white rounded-5 shadow-lg p-5 mb-5">
